...
namespace Bbpro.Infrastructure.Repositories;

public class GenericRepository<T> : IGenericRepository<T>
    where T : Auditable
{

    protected readonly BbproDbContext dbContext;
    protected readonly DbSet<T> dbSet;

    public GenericRepository(BbproDbContext dbContext, IConfiguration configuration)
    {
